      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 py-8">
        ...
        {isCompleted && (
          <article className="bg-white border border-slate-200 rounded-2xl shadow-xl overflow-hidden" data-testid="barrister-print-frame">
            ...
            <div className="px-6 sm:px-10 py-5 bg-red-50 border-y-2 border-red-600" data-testid="barrister-disclaimer-banner">
              <div className="flex items-start gap-3">
                <AlertTriangle className="w-5 h-5 text-red-700 shrink-0 mt-0.5" />
                <p className="text-sm font-bold text-red-800 leading-relaxed">
                  NOT LEGAL ADVICE — This document is an educational tool only. It does NOT constitute legal advice and must NOT be relied upon as such. All analysis, findings, and recommendations must be independently verified by a qualified Australian legal professional before any action is taken.
                </p>
              </div>
            </div>
