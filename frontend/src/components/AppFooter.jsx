...
const AppFooter = () => {
  return (
    <footer data-testid="app-footer">
      ...
      <div className="bg-red-700 py-2.5 sm:py-4 px-4 sm:px-6" data-testid="footer-legal-disclaimer">
        <div className="max-w-5xl mx-auto">
          <div className="flex items-start gap-2 sm:gap-3">
            <AlertTriangle className="w-4 h-4 sm:w-5 sm:h-5 text-white shrink-0 mt-0.5" />
            <div>
              <p className="text-white font-extrabold text-[10px] sm:text-sm uppercase tracking-wide mb-1">
                NOT LEGAL ADVICE
              </p>
              <p className="text-white/90 font-medium text-[8px] sm:text-xs leading-snug sm:leading-relaxed">
              ...
              <p className="text-white/70 text-[8px] sm:text-xs mt-1.5 sm:mt-2">
