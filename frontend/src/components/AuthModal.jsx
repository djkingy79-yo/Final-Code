...
const AuthModal = ({ isOpen, onClose, onSuccess }) => {
  ...
  const previewUrl = process.env.REACT_APP_BACKEND_URL;
  ...
  const googleLoginUrl = `https://auth.emergentagent.com/?redirect=${encodeURIComponent(`${authOrigin}/auth/callback`)}`;
