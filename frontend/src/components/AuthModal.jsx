...
const AuthModal = ({ isOpen, onClose, onSuccess }) => {
  ...
  const handleGoogleLogin = () => {
    ...
    window.location.href = `https://auth.emergentagent.com/?redirect=${encodeURIComponent(redirectUrl)}&t=${Date.now()}`;
  };
      ...
      <DialogContent className="sm:max-w-md p-0 overflow-hidden bg-white border-slate-200" style={{ backgroundColor: "#ffffff", color: "#0f172a" }}>
        ...
        <div className="p-6">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-blue-700 text-white rounded-xl hover:bg-blue-600 transition-colors shadow-sm"
