...
@api_router.websocket("/cases/{case_id}/chat/ws")
...
async def export_report_docx(case_id: str, report_id: str, request: Request):
    ...
    disc_body_run = disc_body.add_run(
        "This application is an educational research tool only and does NOT constitute legal advice. It must NOT be relied upon "
