...
- **s 23A Crimes Act 1900 (NSW), substantial impairment, diminished responsibility (QLD), mental impairment defence (VIC/SA/ACT), unsoundness of mind (WA/TAS) — these are PARTIAL DEFENCES operating on LIABILITY (reducing murder to manslaughter). They are NEVER sentencing mitigation. Classify them as conviction grounds, never as sentence grounds.**
