...
- **Export:** PDF and Word (DOCX). Print button removed per user request.
...
- Barrister View synthesis (locked until 3 reports complete)
- Aggressive "you/your" and "we/us/our" language stripping (backend + frontend)
...
## Pending/Backlog
- P1: Backend refactoring (decompose server.py monolith)
